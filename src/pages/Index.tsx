        ...
        <div className="container-custom relative z-10 text-white">
          <div className="max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4">
              <Button className="bg-restaurant-primary hover:bg-restaurant-primary/90 text-white" onClick={() => scrollToSection('menu')} size="lg">
                اطلب الآن
              </Button>
              <Link to="/menu">
      ...
      <section id="menu" className="section-padding bg-restaurant-accent" dir="rtl">
        <div className="container-custom">
          ...
          <div className="text-center mt-12">
            <Link to="/menu">
              <Button className="bg-restaurant-primary hover:bg-restaurant-primary/90 text-white" size="lg">
              ...
              <form className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input type="text" id="name" className="w-full px-4 py-2 rounded bg-white/10 border border-white/20 text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-restaurant-primary" placeholder="اسمك" />
                  </div>
                  <div>
                    <label htmlFor="email" className="block text-sm font-medium mb-1">البريد الإلكتروني</label>
                    <input type="email" id="email" className="w-full px-4 py-2 rounded bg-white/10 border border-white/20 text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-restaurant-primary" placeholder="بريدك الإلكتروني" />
                  </div>
                </div>
                
                <div>
                  <label htmlFor="message" className="block text-sm font-medium mb-1">الرسالة</label>
                  <textarea id="message" rows={4} className="w-full px-4 py-2 rounded bg-white/10 border border-white/20 text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-restaurant-primary" placeholder="رسالتك"></textarea>
                </div>
